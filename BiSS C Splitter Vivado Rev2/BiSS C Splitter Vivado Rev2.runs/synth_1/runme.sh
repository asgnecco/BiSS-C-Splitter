...
HD_PWD='C:/Users/Austin/Documents/BiSS-C-Splitter/BiSS C Splitter Vivado Rev2/BiSS C Splitter Vivado Rev2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BiSS_Splitter_Rev8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BiSS_Splitter_Rev8.tcl
