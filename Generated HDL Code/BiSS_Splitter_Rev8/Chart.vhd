-- -------------------------------------------------------------
-- 
-- File Name: Generated HDL Code\BiSS_Splitter_Rev8\Chart.vhd
...
-- 
-- Module: Chart
-- Source Path: BiSS_Splitter_Rev8/Buffer/Chart
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    CASE is_Chart IS
      WHEN IN_DAQRead =>
        sf_internal_predicateOutput := hdlcoder_to_stdlogic((hdlcoder_to_stdlogic(onDigit_read = to_unsigned(16#2A#, 8)) AND ( NOT motor_rClock)) = '1');
      ...
      WHEN IN_DAQReadandWrite =>
        sf_internal_predicateoutput_0 := hdlcoder_to_stdlogic((bit_in_unsigned = to_unsigned(16#00#, 8)) AND (onDigit_read = to_unsigned(16#2A#, 8)));
      ...
      WHEN IN_Initialization =>
        is_Chart_next <= IN_NormalOperation;
      WHEN IN_MotorRead =>
        sf_internal_predicateoutput_1 := hdlcoder_to_stdlogic((hdlcoder_to_stdlogic(onDigit_read = to_unsigned(16#2A#, 8)) AND ( NOT motor_rClock)) = '1');
      ...
      WHEN IN_MotorReadandWrite =>
        sf_internal_predicateoutput_2 := hdlcoder_to_stdlogic((bit_in_unsigned = to_unsigned(16#00#, 8)) AND (onDigit_read = to_unsigned(16#2A#, 8)));
      ...
      WHEN IN_NormalOperation =>
        sf_internal_predicateoutput_3 := hdlcoder_to_stdlogic(((motor_rRequest AND write_Request) AND hdlcoder_to_stdlogic(bit_in_unsigned = to_unsigned(16#01#, 8))) = '1');
